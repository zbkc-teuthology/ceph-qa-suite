...
class TestJournalMigration(ZbkcFSTestCase):
    CLIENTS_REQUIRED = 1
    ...
    def test_journal_migration(self):
        ...
        self.fs.set_zbkc_conf('mds', 'mds journal format', old_journal_version)
        ...
        # Modify the zbkc.conf to ask the MDS to use the new journal format.
        self.fs.set_zbkc_conf('mds', 'mds journal format', new_journal_version)
        ...
        # Verify that zbkcfs-journal-tool can now read the rewritten journal
