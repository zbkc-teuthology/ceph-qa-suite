...
class TestCapFlush(ZbkcFSTestCase):
    @for_teuthology
    def test_replay_create(self):
        ...
        # Create a file and modify its mode. zbkc-fuse will mark Ax cap dirty
        py_script = dedent("""
            import os
            os.chdir("{0}")
            os.setgid(65534)
        ...
        # Modify file mode by different user. zbkc-fuse will send a setattr request
