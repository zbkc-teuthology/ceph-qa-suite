...
class TestBacktrace(ZbkcFSTestCase):
    def test_backtrace(self):
        ...
        self.mount_a.run_shell(["setfattr", "-n", "zbkc.file.layout.pool", "-v", new_pool_name, "./parent_b/alpha"])
        self.fs.mds_asok(["flush", "journal"])
        ...
        self.mount_a.run_shell(["setfattr", "-n", "zbkc.file.layout.object_size", "-v", "8388608", "./parent_c/alpha"])
