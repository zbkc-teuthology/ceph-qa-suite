...
class TestScrubChecks(ZbkcFSTestCase):
    """
    ...
    def _checks(self, run_seq):
        ...
        test_repo_path = "{test_path}/zbkc-qa-suite".format(test_path=abs_test_path)
        ...
        filepath = "{repo_path}/suites/fs/basic/clusters/fixed-3-zbkcfs.yaml". \
    ...
    def clone_repo(self, client_mount, path):
        ...
        try:
            ...
            client_mount.run_shell([
                ...
                "http://github.com/zbkc/{repo}".format(repo=repo),
