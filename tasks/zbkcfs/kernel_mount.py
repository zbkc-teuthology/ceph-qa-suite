...
class KernelMount(ZbkcFSMount):
    ...
    def mount(self, mount_path=None, mount_fs_name=None):
        ...
        secret = '{tdir}/zbkc.data/client.{id}.secret'.format(tdir=self.test_dir, id=self.client_id)
    ...
    def kill(self):
        """
        The Zbkc kernel client doesn't have a mechanism to kill itself (doing
    ...
    def _find_debug_dir(self):
        ...
        pyscript = dedent("""
            ...
            def get_id_to_dir():
                result = {}
                for dir in glob.glob("/sys/kernel/debug/zbkc/*"):
    ...
    def get_global_id(self):
        """
        Look up the ZbkcFS client ID for this mount, using debugfs.
        """
